    ...
    <div class="row justify-content-center">
     ...
     <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="form-row">
            <div class="col-md-6">
         <input type="date" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Joining Date" v-model="form.joigningdate">
  <small class="text-danger" v-if="errors.joigningdate"> {{ errors.joigningdate[0] }} </small>
            </div>
