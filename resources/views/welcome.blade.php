  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/create">Add Employee</router-link>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/createSupplier">Add Suppliers</router-link>
            <router-link class="collapse-item" to="/store-supplier">All Suppliers</router-link>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/storecategory">Add Category</router-link>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/storeproduct">Add Products</router-link>
            <router-link class="collapse-item" to="/allproduct">All Products</router-link>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseBootstrap4" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/storexpense">Add Expense</router-link>
            <router-link class="collapse-item" to="/allexpense">All Expenses</router-link>
          </div>
        </div>
      </li>
    </li>
    <li class="nav-item">
      ...
      <div id="collapseBootstrap44" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <router-link class="collapse-item" to="/storecustomer">Add Customer</router-link>
          <router-link class="collapse-item" to="/allcustomer">All Customers</router-link>
        </div>
      </div>
    </li>
      <li class="nav-item">
        ...
        <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link class="collapse-item" to="/givensalary">Add Salary</router-link>
